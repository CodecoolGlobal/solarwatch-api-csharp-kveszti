...
public class SolarControllerTEST
{
        ...
        public void GetSunrise_WithValidInput_ReturnsOkResult()
        {
                ...
                _mockSunriseSunsetApi.Setup(x => x.GetSunriseAndSunset(It.IsAny<Coordinate>(), It.IsAny<string>()))
                        .Returns(solarData);
                _mockJsonProcessor.Setup(x => x.GetSunrise(solarData)).Returns(expectedResult);

                var result = _controller.GetSunrise("Budapest", "Europe/Budapest");
        ...
        [Test]
        public void GetSunrise_WithInvalidInput_Returns_NotFoundObject()
        {
                var solarData = "{}";
                _mockSunriseSunsetApi.Setup(x => x.GetSunriseAndSunset(It.IsAny<Coordinate>(), It.IsAny<string>()))
                        .Returns(solarData);
                ...
                var result = _controller.GetSunrise("Tamtaramm", "Salalalala");
